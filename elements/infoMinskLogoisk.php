...
<p align="center"><b> Медицинский паспорт Логойского района на 01.10.2023</b></p>


<img class = "medPasport" src="imgs/logoiskogo.png" alt="">
...
<div id="table_24">
  ...
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 24");
...
<button id = "btn_24" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
...
<div id="table_25">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 25");
...
<button id = "btn_25" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>


<p>&nbsp;</p>
<p align="center"><b>3.Фельдшерско-акушерские пункты</b> <b>(ФАП) &ndash; </b><b>14</b></p>
<div id="table_26">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 26");
...
<button id = "btn_26" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
...
<div id="table_27">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 27");
...
<button id = "btn_27" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Массив с IDs таблиц
    var tableIds = ['tbl24' ,'tbl25', 'tbl26', 'tbl27'];
