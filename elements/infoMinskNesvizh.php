...
<p align="center"><b> Медицинский паспорт Несвижского района на 01.10.2023</b></p>


<img class = "medPasport" src="imgs/nesvizhsk.png" alt="">
...
<div id="table_72">
  ...
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 72");
...
<button id = "btn_72" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
<p align="center">&nbsp;</p>
<p align="center"><b>2. Амбулатории врача общей практики (АВОП) &ndash; 8</b></p>
<div id="table_73">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 73");
...
<button id = "btn_73" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
<p align="center" style="margin-left:36.0pt;">&nbsp;</p>
<p align="center" style="margin-left:36.0pt;"><b>3.Фельдшерско-акушерских пунктов (ФАП)</b> <b>&ndash; </b><b>15</b></p>
<div id="table_74">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 74");
...
<button id = "btn_74" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
<p align="center">&nbsp;</p>
<p align="center">&nbsp;</p>
<p>&nbsp;</p>
...
<div id="table_75">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 75");
...
<button id = "btn_75" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
<p>&nbsp;</p>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Массив с IDs таблиц
    var tableIds = ['tbl72' ,'tbl73', 'tbl74', 'tbl75'];
