...
<p align="center"><b> Медицинский паспорт Крупоского района на 01.10.2023</b></p>


<img class = "medPasport" src="imgs/krupskogo.png" alt="">
...
<div id="table_15">
  ...
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 15");
...
<button id = "btn_15" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
...
<div id="table_16">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 16");
...
<button id = "btn_16" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>



<p>&nbsp;</p>
<p align="center"><b>3. Фельдшерско-акушерские пункты (ФАП) &ndash; </b><b>18</b></p>
<div id="table_17">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 17");
...
<button id = "btn_17" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
...
<div id="table_18">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 18");
...
<button id = "btn_18" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Массив с IDs таблиц
    var tableIds = ['tbl15' ,'tbl16', 'tbl17', 'tbl18'];
