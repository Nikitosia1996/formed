...
<div id="table_332">
  ...
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 332");
...
<button id = "btn_332" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
<p align="center">&nbsp;</p>
<p align="center"><b>2. Амбулатории врача общей практики (АВОП) &ndash; 2</b></p>
<div id="table_333">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 333");
...
<button id = "btn_333" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
<p align="center" style="margin-left:36.0pt;">&nbsp;</p>
<p align="center" style="margin-left:36.0pt;"><b>3.Фельдшерско-акушерских пунктов (ФАП)</b> <b>&ndash; 9</b></p>
<div id="table_334">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 334");
...
<button id = "btn_334" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
<p align="center">&nbsp;</p>
...
<div id="table_335">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 335");
...
<button id = "btn_335" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
<p>&nbsp;</p>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Массив с IDs таблиц
    var tableIds = ['tbl332' ,'tbl333', 'tbl334', 'tbl335'];
