...
<p align="center">&nbsp;</p>
<ol>
  <li><b>Больничные организации</b></li>
</ol>
<div id="table_247">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 247");
...
<button id = "btn_247" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
<p align="center">&nbsp;</p>
<p align="center"><b>2. Амбулатории врача общей практики (АВОП) &ndash; 2</b></p>
<div id="table_248">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 248");
...
<button id = "btn_248" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
<p>&nbsp;</p>
<p align="center"><b>3. Фельдшерско-акушерские пункты</b> <b>&ndash; 9</b></p>
<div id="table_249">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 249");
...
<button id = "btn_249" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
<p>&nbsp;</p>
...
<div id="table_250">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 250");
...
<button id = "btn_250" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
<p>&nbsp;</p>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Массив с IDs таблиц
    var tableIds = ['tbl247' ,'tbl248', 'tbl249', 'tbl250'];
