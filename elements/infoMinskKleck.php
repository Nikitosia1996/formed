...
<p align="center"><b> Медицинский паспорт Клецкого района на 01.10.2023</b></p>


<img class = "medPasport" src="imgs/kleckogo.png" alt="">
...
<div id="table_59">
  ...
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 59");
...
<button id = "btn_59" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
...
<div id="table_60">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 60");
...
<button id = "btn_60" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>

<p>&nbsp;</p>
<p align="center"><b>3.Фельдшерско-акушерские пункты (ФАП)</b> <b>&ndash; </b><b>12</b></p>
<div id="table_61">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 61");
...
<button id = "btn_61" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
...
<div id="table_62">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 62");
...
<button id = "btn_62" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Массив с IDs таблиц
    var tableIds = ['tbl59' ,'tbl60', 'tbl61', 'tbl62'];
