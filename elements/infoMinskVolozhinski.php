...
<p align="center"><b> Медицинский паспорт Воложинского района на 01.10.2023</b></p>


<img class = "medPasport" src="imgs/volozh.png" alt="">
...
<div id="table_42">
  ...
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 42");
...
<button id = "btn_42" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
...
<div id="table_43">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 43");
...
<button id = "btn_43" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
<p>&nbsp;</p>
<p align="center"><b>3. Фельдшерско-акушерские пункты (ФАП) &ndash; 12</b></p>
<div id="table_44">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 44");
...
<button id = "btn_44" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
...
<div id="table_45">
  <?php
  include '../connection.php';
  $rez = mysqli_query($con,"select `html_text` from `table_info_main` where `id_table_info_main` = 45");
...
<button id = "btn_45" class = "butsavetbl" onclick="savetable(this.id)"> Сохранить </button>
<p>&nbsp;</p>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Массив с IDs таблиц
    var tableIds = ['tbl42' ,'tbl43', 'tbl44', 'tbl45'];
