...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 29 2023 г., 09:31
...
CREATE TABLE `archive_akusherstvo` (
  ...
  `date_prik` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
(1, 1675, 'О реализации пилотного проекта «Скрининг новорожденных г. Минска на первичный иммунодефицит»	', '30.11.2022', 'Приказ МЗ РБ', '/protected/akuserstvo-i-ginekologia/прмз№1675_2022.pdf', '/index.php?archive_akusherstvo'),
(2, 1380, 'Об изменении приказа Министерства здравоохранения Республики Беларусь от 30 августа 2022 №1124', '12.10.2022', 'Приказ МЗ РБ', '/protected/akuserstvo-i-ginekologia/прмз№1380_2022.pdf', '/index.php?archive_akusherstvo'),
(3, 1361, 'Об организации Республиканского центра катамнестического наблюдения недоношенных детей', '06.10.2022', 'Приказ МЗ РБ', '/protected/akuserstvo-i-ginekologia/прмз№1361_2022.pdf', '/index.php?archive_akusherstvo'),
(4, 1201, 'О порядке медицинского наблюдения в амбулаторных условиях', '12.09.2022', 'Приказ МЗ РБ', '/protected/akuserstvo-i-ginekologia/прмз№1201_2022.pdf', '/index.php?archive_akusherstvo'),
(5, 706, 'О проведении прегравидарной подготовки', '27.05.2022', 'Приказ МЗ РБ', '/protected/akuserstvo-i-ginekologia/прмз№706_2022.pdf', '/index.php?archive_akusherstvo'),
(6, 705, 'О порядке проведения ультразвуковой трансвагинальной цервикометрии', '27.05.2022', 'Приказ МЗ РБ', '/protected/akuserstvo-i-ginekologia/прмз№705_2022.pdf', '/index.php?archive_akusherstvo'),
(7, 555, 'О проведении прегравидарной подготовки', '26.04.2022', 'Приказ МЗ РБ', '/protected/akuserstvo-i-ginekologia/прмз№555_2022.pdf', '/index.php?archive_akusherstvo'),
(8, 419, 'О проведении прегравидарной подготовки', '31.03.2022', 'Приказ МЗ РБ', '/protected/akuserstvo-i-ginekologia/прмз№419_2022.pdf', '/index.php?archive_akusherstvo'),
(9, 396, 'О проведении прегравидарной подготовки', '25.03.2022', 'Приказ МЗ РБ', '/protected/akuserstvo-i-ginekologia/прмз№396_2022.pdf', '/index.php?archive_akusherstvo'),
(10, 261, 'О проведении прегравидарной подготовки', '28.02.2022', 'Приказ МЗ РБ', '/protected/akuserstvo-i-ginekologia/прмз№261_2022.pdf', '/index.php?archive_akusherstvo'),
(11, 223, 'О хирургической помощи беременным и новорожденным', '22.02.2022', 'Приказ МЗ РБ', '/protected/akuserstvo-i-ginekologia/прмз№223_2022.pdf', '/index.php?archive_akusherstvo'),
(12, 99, 'О создании банка донорских половых клеток', '27.01.2022', 'Приказ МЗ РБ', '/protected/akuserstvo-i-ginekologia/прмз№99_2022.pdf', '/index.php?archive_akusherstvo'),
...
CREATE TABLE `archive_anesteziologiya-reanimatologiya` (
  ...
  `num_akt` int NOT NULL,
  `name` varchar(255) NOT NULL,
  `date_prik` varchar(255) NOT NULL,
  `type` varchar(255) NOT NULL,
  `file` varchar(255) NOT NULL,
  `url` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `archive_anesteziologiya-reanimatologiya_deyatelnost-s-narkot` (
  ...
  `date_prik` varchar(255) DEFAULT NULL,
...
CREATE TABLE `archive_common-question` (
  `id_akt` int NOT NULL,
  `num_akt` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `name` varchar(255) NOT NULL,
  `date_prik` varchar(255) NOT NULL,
  `type` varchar(255) NOT NULL,
  `file` varchar(255) NOT NULL,
...
CREATE TABLE `forms_statements` (
  ...
  `number_telephone` varchar(200) NOT NULL,
...
(4, 'richard', 'richard@mail.ru', 'bc956474c3bf9fbade3c9a1063dd4e5e', 1, 1680071102, 1680071102);
